    ...
    const validateForm = () => {
        ...
        if(formData.telephone ===""){
            ...
            if(!phoneRegex.test(formData.telephone)){
                err.telephone = "Telephone number invalid"
            }
        }

        if(formData.guests == ""){
            err.guests ="Please specify guests number."
        }
        if(formData.Data.date ==""){
            err.date ="Please specify date and time for your reservation."
        }
